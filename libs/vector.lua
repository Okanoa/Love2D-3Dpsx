...
function Triangle_ClipAgainstPlane(plane_p, plane_n, in_tri, uv)
  plane_n = Vector_Normalise(plane_n)
  ...
  inside_tex = {}; nInsideTexCount = 0
  outside_tex = {}; nOutsideTexCount = 0
  ...
  if (nInsidePointCount == 0) then
    return {0,emptytri,emptytri,emptyuv,emptyuv};
  end

  if (nInsidePointCount == 3) then
    out_tri1 = in_tri
    out_uv1 = uv
    return {1, out_tri1,emptytri,out_uv1,emptyuv};
  end
